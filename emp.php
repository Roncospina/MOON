...
<body>
    ...
    <div class="container3">
        <form action="save_emp.php" method="POST" style="margin: 20px;">
            ...
            <div class="form-group">
                ...
                <input type="telephone" name="telephone" placeholder="Enter your telephone number">
            </div>
            <button type="submit" name="save_emp">Save Changes</button>
        </form>
        <div class="info">
            <?php
            ...
            if ($stmt->rowCount() > 0) {
                ...
                echo "<tr><th>Name</th><th>Last Name</th><th>Telephone</th><th>Actions</th></tr>";
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td>";
                    echo "<a href='edit.php?id=" . $row["id_emp"] . "' class='btn btn-secondary'>";
                    echo "<i class='fa-solid fa-marker fa-xl'></i>";
                    echo "</a>";
                    echo "<a href='delete_employ.php?id=" . $row["id_emp"] . "' class='btn btn-danger'>";
                    echo "<i class='fa-regular fa-trash-can fa-xl'></i>";
                    echo "</a>";
                    echo "</td>";
                    echo "</tr>";
                }
