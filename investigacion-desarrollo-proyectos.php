...
<body>
    ...
    <div class="title-subtitle">
        <span class="welcome-text">Investigation and Development</span>
        <br>
        Projects
    </div>
    <ul id="accordion">
        <li>
            <label for="first">CRUD Projects <span>&#x3e;</span></label>
            <input type="radio" name="accordion" id="first" checked>
            <div class="content">
                <p>
                    In this section, it allows the creation of specific projects for a department within a company.
                    Users will be able to enter the project description, start and end dates, the required number of
                    employees, and the project leader. Once the form is completed, the projects will be saved in a
                    database and will be available for viewing and tracking.</p>
                <button onclick="window.location.href = 'proyecto1.php';">See More</button>
            </div>
        </li>
        <li>
            <label for="second">CRUD Employee <span>&#x3e;</span></label>
            <input type="radio" name="accordion" id="second">
            <div class="content">
                <p>There will be an employee management feature where users can create, edit, and delete employee records. This functionality allows for a basic CRUD (Create, Read, Update, Delete) system for managing employee information. Users will have the ability to add new employees, update their details such as name, position, and contact information, as well as remove employees from the system if necessary. </p>
                <button onclick="window.location.href = 'emp.php';">See More</button>
            </div>
        </li>
    </ul>
    </div>
