...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM projects WHERE id_pro = :id";
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE projects SET description = :description, start_date = :start_date, end_date = :end_date, project_leader = :project_leader WHERE id_pro = :id";
    $stmt = $conn->prepare($query);
...
<body>
    ...
    <div class="container3">
        <form action="edit_project.php?id=<?php echo $_GET['id']; ?>" method="POST">
            <div class="form-group">
                <label for="description">Description:</label>
                <textarea name="description" placeholder="Update Description" required><?php echo $description; ?></textarea>
            </div>
            <div class="form-group">
                <label for="start_date">Start Date:</label>
                <input name="start_date" type="date" value="<?php echo $start_date; ?>" required>
            </div>
            <div class="form-group">
                <label for="end_date">End Date:</label>
                <input name="end_date" type="date" value="<?php echo $end_date; ?>" required>
            </div>
            <div class="form-group">
                <label for="project_leader">Project Leader:</label>
                <input name="project_leader" type="text" value="<?php echo $project_leader; ?>" placeholder="Update Project Leader" required>
            </div>
