...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM employ WHERE id_emp = :id";
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE employ SET name = :name, last_name = :last_name, telephone = :telephone WHERE id_emp = :id";
    $stmt = $conn->prepare($query);
    ...
    <div class="container3">
        <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST">
            <div class="form-group">
                ...
                <input name="name" type="text" value="<?php echo $name; ?>" placeholder="Update Name" required>
            </div>
            <div class="form-group">
                <label for="last_name">Last Name:</label>
                <input name="last_name" type="text" value="<?php echo $last_name; ?>" placeholder="Update Last Name"
                    required>
            </div>
            <div class="form-group">
                <label for="telephone">Telephone:</label>
                <input name="telephone" type="text" value="<?php echo $telephone; ?>" placeholder="Update Telephone"
                    required>
            </div>
