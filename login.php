...
if (!empty($_POST['email']) && !empty($_POST['password'])) {
    ...
    if ($results && password_verify($_POST['password'], $results['password'])) {
        ...
        header('Location: /MOON/departments.php');
        exit;
    } else {
...
<body>
    ...
    <div class="social-icons">
        <a href="https://www.facebook.com"><i class="fab fa-facebook"></i></a> <!-- Icono de Facebook -->
        <a href="https://www.twitter.com"><i class="fab fa-twitter"></i></a> <!-- Icono de Twitter -->
        <a href="https://www.instagram.com"><i class="fab fa-instagram"></i></a> <!-- Icono de Instagram -->
    </div>
