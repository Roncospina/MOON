...
<body>
    ...
    <div class="title-subtitle">
        ...
        <span class="welcome-text">Company Departments</span>
    </div>
        <div class="slide-container">
          <div class="card-wrapper swiper-wrapper">
            <div class="card swiper-slide">
              <div class="image-box">
                <img src="img/ventas.webp" alt="" />
              </div>
              <div class="profile-details">
                <div class="name-job">
                  <h3 class="name">Sales</h3>
                  <h4 class="job">Department in charge of the sale and marketing of products</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
                <a href="investigacion-desarrollo-proyectos.php">
                  <div class="image-box">
                    <img src="img/investigacion-y-desarrollo.jpeg" alt="" />
                  </div>
                  <div class="profile-details">
                    <div class="name-job">
                      <h3 class="name">Investigation and Development</h3>
                      <h4 class="job">Department in charge of research and development of new technologies</h4>
                    </div>
                  </div>
                </a>
              </div>
            <div class="card swiper-slide">
              <div class="image-box">
                <img src="img/desarrollo-de-producto.jpg" alt="" />
              </div>
              <div class="profile-details">
                <div class="name-job">
                  <h3 class="name">Product Development</h3>
                  <h4 class="job">Department in charge of designing and developing new products</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
              ...
              <div class="profile-details">
                <div class="name-job">
                  ...
                  <h4 class="job">Department in charge of financial and accounting management</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
              ...
              <div class="profile-details">
                <div class="name-job">
                  ...
                  <h4 class="job">Department in charge of human talent management</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
              ...
              <div class="profile-details">
                <div class="name-job">
                  ...
                  <h4 class="job">Department in charge of promoting the company's products and services</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
              ...
              <div class="profile-details">
                <div class="name-job">
                  <h3 class="name">Logistics</h3>
                  <h4 class="job">Department in charge of supply chain management</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
              <div class="image-box">
                <img src="img/servicio-al-cliente.jpg" alt="" />
              </div>
              <div class="profile-details">
                <div class="name-job">
                  <h3 class="name">Costumer Service</h3>
                  <h4 class="job">Department in charge of serving and solving the needs of customers</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
              ...
              <div class="profile-details">
                <div class="name-job">
                  ...
                  <h4 class="job">Department in charge of the acquisition of materials and supplies</h4>
                </div>
              </div>
            </div>
            <div class="card swiper-slide">
              <div class="image-box">
                <img src="img/produccion.jpg" alt="" />
              </div>
              <div class="profile-details">
                <div class="name-job">
                  <h3 class="name">Production</h3>
                  <h4 class="job">Department in charge of manufacturing the products</h4>
                </div>
              </div>
            </div>
          </div>
